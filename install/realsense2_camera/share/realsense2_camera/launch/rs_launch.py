...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'color_qos',                    'default': 'SYSTEM_DEFAULT', 'description': 'QoS for color image topic'},
                           {'name': 'color_info_qos',               'default': 'DEFAULT', 'description': 'QoS for color camera_info topic'},
                           {'name': 'depth_qos',                    'default': 'SYSTEM_DEFAULT', 'description': 'QoS for depth image topic'},
                           {'name': 'depth_info_qos',               'default': 'DEFAULT', 'description': 'QoS for depth camera_info topic'},
                           {'name': 'colorizer.enable',             'default': 'false', 'description': "''"},
                           {'name': 'clip_distance',                'default': '1.5', 'description': "''"},                           
                           ...
                           # tf_publish_rate is declared as a double parameter in the driver.
                           # Keep the default value as a float-looking string so ROS 2
                           # does not predeclare it as an integer and trigger a type warning.
