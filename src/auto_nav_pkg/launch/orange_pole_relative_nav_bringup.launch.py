...
def generate_launch_description():
    ...
    # Full HSV-pole route bringup: D435 HSV detector -> relative six-goal route
    # -> nav_executor -> serial bridge. Point-LIO can be started separately, or
    # enabled here for a one-command test.
    # Rollback: use obstacle_race_bringup.launch.py with enable_yolo_relative_nav:=true.
    ...
    return LaunchDescription([
        ...
        # Point-LIO is left off by default because teams often start Livox and
        # localization in a separate terminal for cleaner logs. Set
        # enable_point_lio:=true for a one-command local test.
        ...
        # 2026-05-03 01:40 CST: match the standalone detector launch. Rollback:
        # use 640,480,30 if USB/CPU headroom is enough and smoother debug image
